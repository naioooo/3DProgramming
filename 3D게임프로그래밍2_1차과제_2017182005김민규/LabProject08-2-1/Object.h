...
public:
	...
	virtual void UpdateShaderVariables(ID3D12GraphicsCommandList *pd3dCommandList, XMFLOAT4X4& m_pxmf4x4Transforms);
...
public:
	...
	LPVOID m_pBulletUpdatedContext;
